...
export const navItems = [
  ...
  { to: "/ielts/road-map", label: "Lộ trình IELTS", icon: GraduationCap },
  {
    ...
    icon: GraduationCap,
    subItems: [
      { to: "/ielts/skills/listening", label: "Nghe Lén - Listening", icon: Headphones },
      { to: "/ielts/skills/speaking", label: "Nói Xấu - Speaking", icon: Mic },
      { to: "/ielts/skills/reading", label: "Đọc Trộm - Reading", icon: BookOpen },
      { to: "/ielts/skills/writing", label: "Viết Bậy - Writing", icon: PenTool },
    ],
  },
